...
router.get('/ethernetstatus', async(req, res) => { //know if the ethernet is on or not --> is connection delivered ? 
    fonctions.ethernetstatus((status, err)=>{
...
//----------------------------------------------------------
//entirely made for example purposes, never tested, 
//need someone to add vpn if needed or contact me, I'd be pleased to add the vpn system
